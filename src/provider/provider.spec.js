...
describe("Pact Verification", () => {
  before(async () => {
    ...
    opts = {
      ...
      pactBroker: 'https://pact-pacticipants-dev.empcbr.thoughtworks-labs.net',
      consumerVersionTags: ['main', 'test', 'prod'],
    ...
    process.env.PACT_BROKER_BASE_URL = 'https://pact-pacticipants-dev.empcbr.thoughtworks-labs.net'
    ...
    if (process.env.PACT_BROKER_BASE_URL) {
      opts = {
        ...
        providerVersion: process.env.CIRCLE_SHA1,
        providerVersionBranch: process.env.CIRCLE_BRANCH,
